...
import de.lb.ruleprocessor.checkpoint.server.data.caseRules.RulesCriterion;
...
/**
	...
	protected int toolTipLen = 2048; //350;
		...
		m_descriptionText = de.lb.ruleprocessor.checkpoint.installer.IAActions.CommonOperations.stringAsHTML(descrText,
							toolTipLen);
		m_type = type;
                m_type_show = m_type;
		m_index = index;           
   ...
   public CriterionEntry(int groupIndex, int structIndex, String name, int type, int index, boolean isDepended,
		...
		int type, int index, boolean isDepended, int depend)
	{
		...
		m_descriptionText = de.lb.ruleprocessor.checkpoint.installer.IAActions.CommonOperations.stringArrayAsHTML(m_toolTip,
							toolTipLen);
 	}
		...
		int type, int index, boolean isDepended, int depend)
	{
		...
		m_descriptionText = de.lb.ruleprocessor.checkpoint.installer.IAActions.CommonOperations.stringArrayAsHTML(descrText,
							toolTipLen);
	}
...
//                m_descriptionTextBase = removeXML(text);
		m_descriptionText = de.lb.ruleprocessor.checkpoint.installer.IAActions.CommonOperations.stringAsHTML(text,
							toolTipLen);
	...
	public void setDescriptionText(String []text)
{
	m_descriptionText = de.lb.ruleprocessor.checkpoint.installer.IAActions.CommonOperations.stringArrayAsHTML(text,
						toolTipLen);
